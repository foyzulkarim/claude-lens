...
- [ ] **#P0-7 — Data inventory (observed-field evidence)** *(added 2026-07-06, re-scoped 2026-07-09, expanded 2026-07-10; ordered here — before #P0-3 — because #P0-3 authors synthetic fixtures against the field inventory this task produces: the data-model doc is P0-3's spec)*
...
- [~] **#P0-8 — Harden closed-issue wiki archive convention** *(added 2026-07-11; process/tooling — hardens the 2026-07-10 archive convention, does not gate any phase)*
...
- [ ] **#P1-1 — Scaffold three-root TS package** *(absorbs #P0-5's LICENSE, 2026-07-10 — see decisions log; `.nvmrc` dropped from scope, 2026-07-10)*
